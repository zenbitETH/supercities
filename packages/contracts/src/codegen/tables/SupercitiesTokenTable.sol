...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("SupercitiesToken")));
bytes32 constant SupercitiesTokenTableTableId = _tableId;

library SupercitiesTokenTable {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("SupercitiesTokenTable", _fieldNames);
  }
